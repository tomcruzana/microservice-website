package dev.company.privacypolicy.util;
...
import dev.company.privacypolicy.service.PrivacyPolicyServiceImpl;
...
public class ServiceLoggingAdvise<T> {
	...
	private final Logger serviceLogger = LoggerFactory.getLogger(PrivacyPolicyServiceImpl.class);
