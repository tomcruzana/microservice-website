package dev.company.coupon.util;
...
import dev.company.coupon.service.CouponServiceImpl;
...
public class ServiceLoggingAdvise<T> {
	...
	private final Logger serviceLogger = LoggerFactory.getLogger(CouponServiceImpl.class);
