package dev.company.guestemail.util;
...
import dev.company.guestemail.service.GuestEmailServiceImpl;
...
public class ServiceLoggingAdvise<T> {
	...
	private final Logger serviceLogger = LoggerFactory.getLogger(GuestEmailServiceImpl.class);
