package dev.company.server.gateway.config;
...
/**
 * Zuul configuration. this configuration class file is for
 * ErrorContoller.getErrorPath() see discussion here: https://bit.ly/3FHCr8L
 */
@Configuration
