package dev.company.termsofuse.util;
...
import dev.company.termsofuse.service.TermsOfUseServiceImpl;
...
public class ServiceLoggingAdvise<T> {
	...
	private final Logger serviceLogger = LoggerFactory.getLogger(TermsOfUseServiceImpl.class);
