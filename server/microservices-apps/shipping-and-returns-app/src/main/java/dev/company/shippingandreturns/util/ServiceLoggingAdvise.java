package dev.company.shippingandreturns.util;
...
import dev.company.shippingandreturns.service.ShippingAndReturnsServiceImpl;
...
public class ServiceLoggingAdvise<T> {
	...
	private final Logger serviceLogger = LoggerFactory.getLogger(ShippingAndReturnsServiceImpl.class);
